...
describe("EnvironmentListPage", () => {
  ...
  it("abre el dialogo de horarios con el ambiente seleccionado", async () => {
    ...
    const schedulesButton = screen.getByRole("button", { name: "Asignar horarios Aula 101" });
    ...
    expect(screen.getByTestId("schedules-environment-name").textContent).toBe("Aula 101");
    ...
    await waitFor(() => expect(screen.queryByTestId("mock-schedules-dialog")).not.toBeInTheDocument());
